...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'webweaver.executor.test_suite.normalisation',
        'webweaver.executor.test_suite.suite_loader',
        'webweaver.executor.test_suite.suite_validator',
        'webweaver.executor.test_suite.suite_parser',
        'webweaver.executor.discovery.class_resolver',
        'webweaver.executor.discovery.test_preparation',
        'webweaver.web',
